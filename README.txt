# Mi biblioteca de Ciencia de Datos.

Módulo de Python para cálculos estadísticos.

## Descripción.

Esta librería otorga herramientas para la realización de ciertos cálculos comunes en la Ciencia de Datos, tales como regresión lineal, regresión logística, etc.
...
- Clase TrainTest: dado un conjunto de datos, lo separa en conjuntos para entrenar y testear un modelo, permitiendo especificar el porcentaje de datos que formarán cada conjunto.
